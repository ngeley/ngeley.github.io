...
function main(){
	...
	$("#link1").attr("href","seriesentity.html?name=" + episode1.series + "&season=" + episode1.season + "&episode=" + episode1.episode);
	$("#poster2").attr("src",series[1].picUrl);
	$("#title2").html(series[1].name + " (" + series[1].yearsActive + ")");
	var episode1 = findEpisode(series[1]);
	$("#link2").attr("href","seriesentity.html?name=" + episode1.series + "&season=" + episode1.season + "&episode=" + episode1.episode);
	$("#poster3").attr("src",series[2].picUrl);
	$("#title3").html(series[2].name + " (" + series[2].yearsActive + ")");
	var episode1 = findEpisode(series[2]);
	$("#link3").attr("href","seriesentity.html?name=" + episode1.series + "&season=" + episode1.season + "&episode=" + episode1.episode);
	console.log(series);
}